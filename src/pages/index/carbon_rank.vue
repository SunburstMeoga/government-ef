<template>
    <div class="flex flex-col justify-start items-center">
        ...
        <div class="fixed flex bottom-0 left-0 w-full justify-evenly items-center h-204rpx bg-white">
            <div class="w-112rpx h-96rpx mt-17rpx" v-for="(item, index) in operatingTypes" :key="index">
                <img :src="item" alt="">
            </div>
        </div>
    </div>
...
let operatingTypes = ref([
    '../../static/home/bottom-1.png',
    '../../static/home/bottom-2.png',
    '../../static/home/bottom-3.png',
    '../../static/home/bottom-4.png',
