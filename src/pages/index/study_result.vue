        ...
        <div class="flex w-full pt-48rpx flex-col items-center justify-start">
            <div class="flex w-686rpx items-center justify-between">
                <div class="flex flex-col justify-start items-start text-slate-9">
                    ...
                    <div class="flex items-baseline">共答对 <span class="text-60rpx mx-8rpx">4</span> 题</div>
                </div>
            ...
            <div class="flex w-686rpx flex-col mb-200rpx">
                ...
                <div class="flex rounded-24rpx bg-white flex-col items-center justify-start -mt-38rpx pt-60rpx">
                    <div class="flex flex-col w-618rpx mb-32rpx" v-for="(item, index) in resultList" :key="index">
                        <div class="text-slate-9 font-bold mb-24rpx">{{ item.title }} [{{ item.judge === 0 ? '错误' : '正确'
                            }}] </div>
                        <div class="flex ml-50rpx flex-col justify-start items-center text-28rpx w-566rpx">
                            <div class="flex mb-18rpx w-full"
                                ...
                                v-for="(_item, _index) in item.answer" :key="_index">{{ _item.title }}</div>
                        </div>
...
const navbar = ref(0)
let resultList = ref([
    { title: '01 以下哪些行为是正确的保护环境?', judge: 0, answer: [{ title: 'A  乱丢垃圾' }, { title: 'B  砍伐树木', isError: true }, { title: 'C  不挂机', isRight: true }, { title: 'A  我不知道' }], analysis: '保护环境人人有责' },
    { title: '02 以下哪些行为是正确的保护环境?', judge: 1, answer: [{ title: 'A  乱丢垃圾' }, { title: 'B  砍伐树木', isError: true }, { title: 'C  不挂机', isRight: true }, { title: 'A  我不知道' }], analysis: '保护环境人人有责' },
    { title: '03 以下哪些行为是正确的保护环境?', judge: 1, answer: [{ title: 'A  乱丢垃圾' }, { title: 'B  砍伐树木', isError: true }, { title: 'C  不挂机', isRight: true }, { title: 'A  我不知道' }], analysis: '保护环境人人有责' },
    { title: '04 以下哪些行为是正确的保护环境?', judge: 1, answer: [{ title: 'A  乱丢垃圾' }, { title: 'B  砍伐树木', isError: true }, { title: 'C  不挂机', isRight: true }, { title: 'A  我不知道' }], analysis: '保护环境人人有责' },
    { title: '05 以下哪些行为是正确的保护环境?', judge: 1, answer: [{ title: 'A  乱丢垃圾' }, { title: 'B  砍伐树木', isError: true }, { title: 'C  不挂机', isRight: true }, { title: 'A  我不知道' }], analysis: '保护环境人人有责' },
