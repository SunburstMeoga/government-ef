...
<template>
  <div class="">
    <div class="flex flex-col items-center relative h-586rpx">
      ...
      <div
        class="relative z-1 flex justify-center items-center w-full"
    ...
    <div
      class="flex flex-col justify-start items-center w-full -mt-370rpx relative z-2 rounded-t-24rpx"
    >
      <div class="flex w-686rpx mb-50rpx">
        <div class="flex p-8rpx rounded-12rpx" style="border: 1px solid #fff">
          <div
            @click="handleType(item)"
            class="flex px-20rpx py-8rpx text-28rpx rounded-12rpx"
      ...
      <div
        class="rounded-t-24rpx bg-white w-full flex flex-col items-center justify-start mb-22rpx"
      >
        <div class="flex justify-between items-start w-694rpx mt-60rpx">
          <div
            class="flex justify-center items-center"
            :class="item.style"
            v-for="(item, index) in rankTopThree.slice(0, 3)"
            :key="index"
          >
      ...
      <div class="w-686rpx">
        <div
          v-for="(item, index) in rankTopThree.slice(-7)"
          :key="index"
